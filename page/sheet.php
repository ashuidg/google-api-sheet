...
<div class="ts raised segment">
    ...
    <p>因為他不會即時更新，你可以<a href="https://docs.google.com/spreadsheets/d/1NDTYQI17Hojjsd6lPRsHiiBrfkOUWGfzVnODmT-y8hY/edit#gid=1118095092" target="_blank">開啟</a>試算表查看資料變化，或按 <button class="ts pulsing button" onclick="load_google_sheets()">這裡</button> 更新試算表。</p>
</div>
<iframe id="google_sheets" src="https://docs.google.com/spreadsheets/d/1NDTYQI17Hojjsd6lPRsHiiBrfkOUWGfzVnODmT-y8hY/gviz/tq?tqx=out:html&tq&gid=0"
...
function select_uid(){
    ...
    var URLs = "/api/google-api-sheet/ajax.php?todo=select" + "&uid=" + $uid;
    $.ajax({
        url: URLs,
        type: "POST",
        dataType: 'text',
...
function insert_uid(){
    ...
    var URLs = "/api/google-api-sheet/ajax.php?todo=insert" + "&uid=" + $uid + "&name=" + $name;
    $.ajax({
        url: URLs,
        type: "POST",
        dataType: 'text',
...
function update_uid(){
    ...
    var URLs = "/api/google-api-sheet/ajax.php?todo=update" + "&uid=" + $uid + "&money=" + $money;
    $.ajax({
        url: URLs,
        type: "POST",
        dataType: 'text',
...
function delete_uid(){
    ...
    var URLs = "/api/google-api-sheet/ajax.php?todo=delete" + "&uid=" + $uid;
    $.ajax({
        url: URLs,
        type: "POST",
        dataType: 'text',
